...
namespace PersistenceFramework.DbContextTest.UnitTest
{
    ...
    public class MockMongoDbContextTest
    {
        ...
        public void GetList_NotICollectionExist_Exception()
        {
            ...
            Assert.AreEqual(exception.InnerException.Message, "You most declare the entity as public ICollection<> property");
        }
    ...
    {
        public ICollection<InfoEntity> InfoEntity { get; set; } = new List<InfoEntity>();
        public ICollection<NullDeclareEntity> NullDeclareEntity { get; set; }
